...
/*
    ...
    public function empresas($empresa = null, $pag = null, $log = null) {
        
        if($pag == null){
            if($this->input->post('postar') != null){
                if(!empty($this->input->post('msg'))){
                    $msg = $this->input->post('msg');
                    if($this->ver_model->grava_post($empresa, $msg)){
            ...
            $dados['postagens'] = $this->ver_model->postagens($empresa);
            $dados['empresa'] = $this->ver_model->retorna_dados_empresa($empresa);
            if($dados['empresa']){
                $this->load->view('ver/header', $dados);
                $this->load->view('ver/home', $dados);
                $this->load->view('ver/footer');
            }else{
        ...
        if($pag == "produtos"){
            $dados['empresa'] = $this->ver_model->retorna_dados_empresa($empresa);
            $dados['produtos'] = $this->ver_model->retorna_todos_produtos($empresa);
            if($dados['empresa']){
                $this->load->view('ver/header', $dados);
                $this->load->view('ver/produtos', $dados);
                $this->load->view('ver/footer');
            }else{
                echo "Ops! Algo deu errado!";
            }
        ...
        if($pag == "contato"){
            $dados['empresa'] = $this->ver_model->retorna_dados_empresa($empresa);
            $dados['atividade'] = $this->ver_model->retorna_nome_atividade($dados['empresa']->atividade_principal_id);
            if($dados['empresa']){
                $this->load->view('ver/header', $dados);
                $this->load->view('ver/contato', $dados);
                $this->load->view('ver/footer');
            }else{
                echo "Ops! Algo deu errado!";
            }
        ...
        if($pag == "r"){
            $this->ver_model->registra_busca($empresa, $log);
            redirect("ver/empresas/" . $empresa);
        }
