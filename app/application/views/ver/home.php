      ...
      <div class="jumbotron" style="margin-top: 20px;">
        <h1 class="display-3"><?= $empresa->nome ?></h1>
      </div>
        ...
        <div class="col-md-12">
            ...
            <form action="" method="post">
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Enviar postagem:</label>
                    <textarea class="form-control" name="msg" rows="3"></textarea>
                </div>
                <div style="float: right;">
                    <input type="submit" name="postar" value="Postar" class="btn btn-outline-success">
                </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <b>atividade_principal</b> <?= $user->atividade_principal; ?><br>
